...
@section('content')
    <style>
        ...
        /* Primary button (Add Subscription) */
        .btn-primary {
            background-color: #1abc9c;
            color: white;
            border: none;
        ...
        /* Warning button (Edit Subscription) */
        .btn-warning {
        ...
        /* Danger button (Delete Subscription - Red) */
        .btn-danger {
            background-color: #e74c3c;
            color: white;
            border: none;
    ...
    <div class="main-content">
                ...
                <tbody>
                    @foreach ($subscriptions as $subscription)
                        <tr>
                            ...
                            <td>{{ str_replace('_', ' ', ucfirst($subscription->duration)) }}</td>
        ...
        <a href="{{ route('subscriptions.create') }}" class="btn btn-primary btn-lg">Add New Subscription</a>
    </div>
@endsection
